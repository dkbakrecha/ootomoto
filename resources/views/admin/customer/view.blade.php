...
<div class="form-group">
    <label for="visit" class="col-sm-3 control-label">{{ __('messages.visits') }}</label>

    <div class="col-sm-9">
        <input id="visit" type="text" placeholder="{{ __('messages.visits') }}" class="form-control" name="address" value="0 visit" disabled="">          
    </div>
</div>

<div class="form-group">
    <label for="payments" class="col-sm-3 control-label">{{ __('messages.payments') }}</label>

    <div class="col-sm-9">
        <input id="payments" type="text" placeholder="{{ __('messages.payments') }}" class="form-control" name="address" value="0 sar" disabled="">          
    </div>
</div>